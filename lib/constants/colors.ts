export const Colors = {
  light: {
    themed_content: '#0A8ED9',
    themed_content_error: '#f87171',
    themed_background: 'rgba(55, 119, 255, 0.15)',

    bottom_tab_bar_background: '#1E293B',
    bottom_tab_bar_icon_active: '#FFFFFF',
    bottom_tab_bar_icon_inactive: '#64748B',

    input_wrapper_background: '#EEF5F8',

    active_marker_color: '#6ED6FF',
    inactive_marker_color: '#FFFFFF',
  ...
  dark: {
    ...
    active_marker_color: '#A7E3D6',
    inactive_marker_color: '#0F6F63',
    ...
    button_bg_primary_filled: '#1DA193',
    button_bg_primary_gradient: 'rgba(41, 227, 180, 0.15)',
    button_text_primary_hollow: '#29E3B4',
    button_text_primary_filled: '#FFFFFF',
    button_text_primary_gradient: '#29E3B4',

    button_bg_secondary_filled: '#0A8ED9',
    button_bg_secondary_gradient: 'rgba(55, 119, 255, 0.15)',
    button_text_secondary_hollow: '#0A8ED9',
    button_text_secondary_filled: '#FFFFFF',
    button_text_secondary_gradient: '#0A8ED9',
